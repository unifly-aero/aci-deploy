...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (taskParams._networkProfile) {
                containerGroupInstance.networkProfile = {
                    "id": taskParams.networkProfile
                }
            }
            let containerDeploymentResult = yield client.containerGroups.createOrUpdate(taskParams.resourceGroup, taskParams.containerGroupName, containerGroupInstance);
